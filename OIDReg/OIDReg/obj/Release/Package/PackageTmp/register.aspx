            ...
            <div>
                ...
                <div style="margin-top:20px;">
			        ...
			        <div style="margin-left:10px;">
                        ...
                        <div><asp:TextBox ID="txtName1" runat="server" Width="300px" MaxLength="240" CssClass="inputtext">ศิริวรรณ  แสนวัง</asp:TextBox>&nbsp;<asp:Label ID="lblNameTh" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>ชื่อ-นามสกุล (ภาษาอังกฤษ)</div>
                        <div><asp:TextBox ID="txtNameEn" runat="server" Width="300px" MaxLength="240" CssClass="inputtext">siriwan sanwang</asp:TextBox>&nbsp;<asp:Label ID="lblNameEn" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>อีเมล</div>
                        <div><asp:TextBox ID="txtEmail" runat="server" Width="300px" MaxLength="500" CssClass="inputtext">siriwan@etda.or.th</asp:TextBox>&nbsp;<asp:Label ID="lblEmail" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>โทรศัพท์</div>
                        <div><asp:TextBox ID="txtContactPhone" runat="server" Width="300px" MaxLength="50" CssClass="inputtext">025260588</asp:TextBox>&nbsp;<asp:Label ID="lblContactPhone" runat="server" ForeColor="red">*</asp:Label></div>
               ...
               <div style="margin-top:20px;">
			        ...
			        <div style="margin-left:10px;">
                        <div>ชื่อ นามสกุล (ภาษาไทย)</div>
                        <div><asp:TextBox ID="txtContactName1" runat="server" Width="300px" MaxLength="240" CssClass="inputtext">ศิริวรรณ  แสนวัง</asp:TextBox>&nbsp;<asp:Label ID="lblContactName1" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>ชื่อ นามสกุล (ภาษาอังกฤษ)</div>
                        <div><asp:TextBox ID="txtContactName2" runat="server" Width="300px" MaxLength="240" CssClass="inputtext">siriwan sanwang</asp:TextBox>&nbsp;<asp:Label ID="lblContactName2" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>อีเมล</div>
                        <div><asp:TextBox ID="txtContactEmail" runat="server" Width="300px" MaxLength="500" CssClass="inputtext">siriwan@npms.or.th</asp:TextBox>&nbsp;<asp:Label ID="lblContactEmail" runat="server" ForeColor="red">*</asp:Label></div>
                        <div style="margin-top:10px; border-bottom:1px dashed #cccccc;"></div>
			        </div>
                </div>      
                ...
                <div style="margin-top:20px;">
			        ...
			        <div style="margin-left:10px;">
                        ...
                        <div><asp:TextBox ID="txtOrgNameTh" runat="server" Width="300px" MaxLength="240" CssClass="inputtext">สพธอ</asp:TextBox>&nbsp;<asp:Label ID="lblOrgName1" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>ชื่อหน่วยงาน (ภาษาอังกฤษ)</div>
                        <div><asp:TextBox ID="txtOrgNameEn" runat="server" Width="300px" MaxLength="240" CssClass="inputtext">etda</asp:TextBox>&nbsp;<asp:Label ID="lblOrgName2" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>สังกัด</div>
                        <div><asp:TextBox ID="txtMinistry" runat="server" Width="300px" MaxLength="240" CssClass="inputtext">มาตรฐาน</asp:TextBox></div>
                        <div>อีเมล</div>
                        <div><asp:TextBox ID="txtOrgEmail" runat="server" Width="300px" MaxLength="500" CssClass="inputtext">siriwan@etda.or.th</asp:TextBox>&nbsp;<asp:Label ID="lblOrgEmail" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>เว็บไซต์</div>
                        <div><asp:TextBox ID="txtWebSite" runat="server" Width="300px" MaxLength="240" CssClass="inputtext"></asp:TextBox>&nbsp;</div>
                        <div>โทรศัพท์</div>
                        <div><asp:TextBox ID="txtOrgPhone" runat="server" Width="300px" MaxLength="50" CssClass="inputtext">025260588</asp:TextBox>&nbsp;<asp:Label ID="lblOrgPhone" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>โทรสาร</div>
                        ...
                        <div><asp:TextBox ID="txtOrgAddress" runat="server" TextMode="MultiLine" Width="420px" Height="50px" MaxLength="1000" CssClass="inputtext">025260588</asp:TextBox>&nbsp;<asp:Label ID="lblOrgAddress" runat="server" ForeColor="red">*</asp:Label></div>
                        <div style="margin-top:10px; border-bottom:1px dashed #cccccc;"></div>
			        </div>
                </div>	
                ...
                <div style="margin-top:20px;">
			        ...
			        <div style="margin-left:10px;">
                        ...
                        <div><asp:TextBox ID="txtOIDSecondary" runat="server" Width="300px" MaxLength="250" CssClass="inputtext">t1</asp:TextBox>&nbsp;<asp:Label ID="lblOIDSecondary" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>ป้ายชื่อยูนิโคดแบบที่ไม่ใช่จำนวนเต็ม (Non-integer Unicode label)</div>
                        <div><asp:TextBox ID="txtUnicodeLabel" runat="server" Width="300px" MaxLength="250" CssClass="inputtext">t1</asp:TextBox>&nbsp;<asp:Label ID="lblUnicodeLabel" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>คำอธิบาย (Description)</div>
                        <div><asp:TextBox ID="txtDesc" runat="server" Width="300px" MaxLength="250" CssClass="inputtext">t1</asp:TextBox>&nbsp;<asp:Label ID="lblDescription" runat="server" ForeColor="red">*</asp:Label></div>
