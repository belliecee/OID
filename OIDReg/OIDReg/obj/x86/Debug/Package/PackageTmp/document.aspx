...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="main">
            <asp:HiddenField ID="hidFileCount" runat="server" />
            <div>
                ...
                <div style="margin-top:20px;">
			        ...
			        <div style="margin-left:10px;">
                        ...
                        <div>
                            <asp:DropDownList ID="ddlFileType" runat="server" Height="22px" Width="420px" CssClass="inputdropdown" 
                                DataSourceID="SqlDataSource1" DataTextField="type_name" DataValueField="type_id"></asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LocalDatabase %>" SelectCommand="SELECT [type_id], [type_name] FROM [register_document_type] WHERE type_matched=@parent">
                                <SelectParameters>
                                    <asp:SessionParameter Name="parent" SessionField="parent" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </div>
                        <div>เลือกไฟล์</div>
                        ...
                        <div style="margin-top:10px; border-bottom:1px dashed #cccccc;">
                        ...
                        <ItemTemplate>
                            <tr valign="top"  id="tr_item" runat="server">
                                ...
                                <td style="text-align:center">
                                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">ลบเอกสาร</asp:LinkButton></td>
                            </tr>
                        </ItemTemplate>
                        <EmptyDataTemplate>
...
WHERE doc_reqid=@reqid" OnSelected="SqlDataSource2_Selected">
                        <SelectParameters>
