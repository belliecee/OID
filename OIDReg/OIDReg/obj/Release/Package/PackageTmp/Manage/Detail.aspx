<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/Manage.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="OIDReg.Manage.Detail" %>
        ...
        <div id="main">
            <div>
                ...
                <div style="width:820px">
                    <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" OnItemDataBound="ListView1_ItemDataBound">
                        <ItemTemplate>
                            <tr valign="top"  id="tr_item" runat="server" style="background-color:#fff">
                                ...
                                <td>
                                    Parent : <span style="color:blue"><%#Eval("request_parent_id")%></span>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:LocalDatabase %>" SelectCommand="SELECT * FROM [node_request_entry] WHERE request_id=@reqid ORDER BY request_entry_id">
                        <SelectParameters>
