...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="maindiv" >        
        <div style="margin:0px 15px;">
            <div style="font-weight:bold;font-size:12pt;margin-bottom:5px;">รายการคำขอลงทะเบียนข้อมูลโอไอดี</div> 
                ...
                <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" OnItemDataBound="ListView1_ItemDataBound" >
                    <ItemTemplate>
                        <tr valign="top"  id="tr_item" runat="server">
                            ...
                            <td style="text-align:center"><%#Eval("ustate_desc") %></td>
                            <td>
                                <asp:LinkButton ID="linkSubmit" runat="server" OnClick="SendRequest_Click">เห็นชอบ </asp:LinkButton> 
