            ...
            <div>
                ...
                <div style="margin-top:20px;">
			        ...
			        <div style="margin-left:10px;">
                        ...
                        <div><asp:TextBox ID="txtOIDInt" runat="server" Width="80px" MaxLength="10" ToolTip="การกำหนดค่าจำนวนเต็มปฐมภูมิให้เป็นไปตามเกณฑ์ที่หน่วยงานภายใต้ สพธอ. ควรกำหนดเป็นเลข Running ที่ไม่ซ้ำกัน" ></asp:TextBox>
                            &nbsp;<asp:Label ID="lblOIDInt" runat="server" ForeColor="Red">*</asp:Label>
                        </div>
                        <div>ป้ายชื่อยูนิโค๊ดแบบจำนวนเต็ม (integer-valued Unicode Label)</div>
                        <div><asp:TextBox ID="txtOIDLabel" runat="server" Width="80px" MaxLength="240" ToolTip="สำหรับป้ายชื่อยูนิโคดแบบจำนวนเต็มจะถูกกำหนดให้มีค่าเหมือนกับค่าจำนวนเต็มปฐมภูมิ"  ></asp:TextBox>
                            &nbsp;<asp:Label ID="lblOIDLabel" runat="server" ForeColor="Red">*</asp:Label>
                        </div>
...
3 เครื่องหมายยัติภังค์ต้องไม่ใช้ลงท้ายและต้องไม่ใช้ติดกันสองตัว '--'"  ></asp:TextBox>
                            &nbsp;<asp:Label ID="lblOIDSecondary" runat="server" ForeColor="Red">*</asp:Label>
                        </div>
                        <div>ป้ายชื่อยูนิโค๊ดแบบที่ไม่ใช่จำนวนเต็ม (Non-integer Unicode label)</div>
                        <div><asp:TextBox ID="txtUnicodeLabel" runat="server" Width="300px"  MaxLength="240" ></asp:TextBox>
                            &nbsp;<asp:Label ID="lblUnicodeLabel" runat="server" ForeColor="Red">*</asp:Label>
                        </div>
