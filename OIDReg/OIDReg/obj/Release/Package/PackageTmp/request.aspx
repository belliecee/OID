<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="request.aspx.cs" Inherits="OIDReg.request" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hidRegID" runat="server" />
		<div id="main">
            <div>
			    <h2>แบบคำขอลงทะเบียน <span style="color:red">(แก้ไข)</span></h2>		
                ...
                <div style="margin-top:20px;">
 			        <div style="font-weight:bold; margin-left:10px;margin-bottom:10px;">ส่วนที่ 1 ข้อมูลของผู้ยื่นคำร้อง หรือ ผู้ดำเนินการของหน่วยงาน
                        ...
                        <br />
                        <span class="auto-style1"><strong>ผู้ยื่นคำร้อง</strong> มีหน้าที่ในการส่งแบบคำขอลงทะเบียนและเอกสารที่เกี่ยวข้องทางเว็บไซต์ลงทะเบียนหมายเลขโอไอดี รวมถึงการส่งข้อมูลเพิ่มเติมตามที่เจ้าหน้าที่รับลงทะเบียนร้องขอ<br /> <strong><span class="auto-style2">ผู้ดำเนินการของหน่วยงาน</span> </strong>มีหน้าที่ในการบริหารจัดการข้อมูลหมายเลขโอไอดีภายใต้กิ่งของหน่วยงานผ่านทางเว็บไซต์ลงทะเบียนหมายเลขโอไอดี เพื่อนำเสนอต่อผู้มีสิทธิ์อนุมัติของหน่วยงาน</span></div>		
			        <div style="margin-left:10px;">
                        <div>ชื่อ-นามสกุล (ภาษาไทย)</div>
                        <div><asp:TextBox ID="txtNameTh" runat="server" Width="300px" MaxLength="240" CssClass="inputtext"></asp:TextBox>&nbsp;<asp:Label ID="lblNameTh" runat="server" ForeColor="red">*</asp:Label></div>
                ...
                <div style="margin-top:20px;">
			        ...
			        <div style="margin-left:10px;">
                        <div>ชื่อ นามสกุล (ภาษาไทย)</div>
                        <div><asp:TextBox ID="TextBox1" runat="server" Width="300px" MaxLength="240" CssClass="inputtext"></asp:TextBox>&nbsp;<asp:Label ID="Label1" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>ชื่อ นามสกุล (ภาษาอังกฤษ)</div>
                        <div><asp:TextBox ID="TextBox2" runat="server" Width="300px" MaxLength="240" CssClass="inputtext"></asp:TextBox>&nbsp;<asp:Label ID="Label2" runat="server" ForeColor="red">*</asp:Label></div>
                        <div>อีเมล</div>
                        <div><asp:TextBox ID="TextBox3" runat="server" Width="300px" MaxLength="500" CssClass="inputtext"></asp:TextBox>&nbsp;<asp:Label ID="Label3" runat="server" ForeColor="red">*</asp:Label></div>
                        <div style="margin-top:10px; border-bottom:1px dashed #cccccc;"></div>
			        </div>
                </div>      
